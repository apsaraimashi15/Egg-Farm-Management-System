...
router.post('/mark', auth, authorize('hrmanager'), attendanceController.markAttendance);
...
router.get('/summary', auth, authorize('hrmanager'), attendanceController.getEmployeesMonthlySummary);
