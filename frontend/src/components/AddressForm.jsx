        ...
        <div className="flex items-center space-x-2">
          <div
            className={`w-2 h-2 rounded-full ${
              Object.values(fieldValidity).every((v) => v) &&
          ...
          <span className="text-sm text-slate-600">
            {Object.values(fieldValidity).filter((v) => v).length}/
            {Object.keys(address).length} fields valid
          </span>
        </div>
      </div>
        ...
        <div className="md:col-span-2">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 ${getFieldClasses(
                "fullName"
              )}`}
            ...
            <div className="mt-2 flex items-start space-x-2">
              ...
              <p className="text-sm text-red-600">
                {fieldErrors.phoneNumber ||
                  "Please enter a valid Sri Lankan phone number (+94XXXXXXXXX or 0XXXXXXXXX)"}
              </p>
            </div>
          )}
          <p className="mt-1 text-xs text-slate-500">
            Example: +94712345678 or 0712345678
          </p>
        </div>
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-slate-700 mb-2">
        ...
        <div>
          ...
          {touchedFields.city && !fieldValidity.city && (
            <div className="mt-2 flex items-start space-x-2">
              ...
              <p className="text-sm text-red-600">
                {fieldErrors.city ||
                  "City name must be at least 2 characters and contain only letters"}
              </p>
            </div>
          )}
        </div>
        <div>
          ...
          <div className="relative">
            <select
              ...
              onChange={handleFieldChange}
              onBlur={handleFieldBlur}
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 appearance-none ${getFieldClasses(
                "district"
              )}`}
              required
            >
          ...
          {touchedFields.district && !fieldValidity.district && (
            <div className="mt-2 flex items-start space-x-2">
              ...
              <p className="text-sm text-red-600">
                {fieldErrors.district || "Please select a district"}
              </p>
            </div>
          )}
        </div>
        <div>
          ...
          {touchedFields.province && !fieldValidity.province && (
            <div className="mt-2 flex items-start space-x-2">
              ...
              <p className="text-sm text-red-600">
                {fieldErrors.province || "Please select a province"}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="md:col-span-2">
          ...
          {touchedFields.nic && !fieldValidity.nic && address.nic && (
            <div className="mt-2 flex items-start space-x-2">
              ...
              <p className="text-sm text-red-600">
                {fieldErrors.nic ||
                  "Please enter a valid Sri Lankan NIC (9 digits + V/X or 12 digits)"}
              </p>
            </div>
          )}
          <p className="mt-1 text-xs text-slate-500">
            Examples: 123456789V (old format) or 200012345678 (new format)
          </p>
        </div>
      </div>
    </div>
