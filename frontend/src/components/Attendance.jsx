                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <p className="text-slate-300 max-w-2xl">
                      Manage employee attendance records, mark daily attendance
                      for today, and review monthly summaries.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-8">
              <div className="px-6 py-4 border-b border-slate-200">
                ...
                <p className="text-sm text-slate-600 mt-1">
                  Select an employee to mark attendance for today ({today})
                </p>
              </div>
              <div className="p-6">
                <form
          ...
          >
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-purple-600 rounded-xl flex items-center justify-center text-white font-semibold text-lg mr-4">
                  {selectedRecord.userId?.name
                    ? selectedRecord.userId.name.charAt(0).toUpperCase()
                    : "U"}
                </div>
                <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-900">
                  {selectedRecord.markedBy?.name || "Unknown"} (
                  {selectedRecord.markedBy?.email})
                </p>
              </div>
