                  ...
                  <div className="ml-4 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-2xl font-bold text-slate-900">
                        {loading
                          ? "..."
                          : Math.floor(parseFloat(stats.totalSpent) * 10)}
                      </dd>
                    </dl>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {featuredProducts.map((product) => (
                  <div
                    key={product.id}
                    className="group bg-slate-50 rounded-xl p-6 hover:bg-slate-100 transition-all duration-300 hover:shadow-lg border border-slate-200 hover:border-slate-300"
                  >
                      ...
                      <div className="flex items-center">
                        <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center mr-4">
                          <span className="text-emerald-600">
                            {purchase.items[0]?.productType === "eggs"
                              ? "🥚"
                              : purchase.items[0]?.productType === "fertilizer"
                              ? "🌱"
                              : "🌾"}
                          </span>
                        </div>
