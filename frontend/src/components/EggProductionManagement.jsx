...
const schema = yup.object({
  ...
  type: yup
    .string()
    .typeError("Enter the type here.")
    .max(10, "Type too long")
...
const EggProductionManagement = () => {
  ...
  const generatePDF = async () => {
    try {
      ...
      y += 6;
      doc.text(
        `Rows: ${totals.rows}   |   Unique Days: ${totals.uniqueDays}   |   Total Qty: ${totals.totalQty}`,
        margin,
        y
      );
      y += 8;
                      ...
                      <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center mr-4">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M12 8c1.5 0 3 .5 4 1.5M8 16a6 6 0 118 0M7 12h10"
                          />
                        </svg>
                      </div>
                      <div>
                        ...
                        <p className="text-emerald-100 text-lg">
                          Record daily production and manage stock updates
                        </p>
                      </div>
                    </div>
                    <p className="text-slate-300 max-w-2xl">
                      Add, edit, and review daily egg production entries. Use
                      the date filter to quickly find a specific day's record.
                    </p>
                  </div>
              ...
              {filtered.length === 0 && (
                <div className="text-center py-12">
                  <div className="w-16 h-16 bg-slate-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={1.5}
                        d="M9 12h6M12 9v6m9 3a9 9 0 11-18 0 9 9 0 0118 0z"
                      />
                    </svg>
                  </div>
                  ...
                  <p className="text-slate-500 mb-6">
                    Start by adding today's production.
                  </p>
                  <button
                    onClick={openAddModal}
          ...
          >
            <div className="text-center">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">
                Delete egg production for{" "}
                <span className="font-semibold text-slate-900">
                  {toInputDate(recordToDelete.date)}
                </span>
