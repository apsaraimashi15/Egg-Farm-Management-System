...
const FertilizerManagement = () => {
  ...
  const totals = useMemo(() => {
    const collected = fertilizers.reduce(
      (a, b) => a + (Number(b.quantityCollected) || 0),
      0
    );
    const used = fertilizers.reduce(
    ...
    return {
      collected,
      used,
      remaining: collected - used,
      rows: fertilizers.length,
    };
  }, [fertilizers]);
          ...
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-green-900 via-emerald-900 to-green-800 rounded-2xl p-8 mb-8 text-white">
              ...
              <p className="text-emerald-100 text-lg">
                Track collected and used fertilizer by month
              </p>
                  ...
                  <tbody className="divide-y divide-slate-200">
                    {fertilizers.map((f, idx) => (
                      <tr key={f._id}>
                        ...
                        <td className="px-6 py-4 text-sm">
                          {f.quantityCollected - f.usedQuantity}
                        </td>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="number"
                    {...register("quantityCollected")}
                    className="w-full border p-2 rounded"
                  />
                  {errors.quantityCollected && (
                    <p className="text-sm text-red-600">
                      {errors.quantityCollected.message}
                    </p>
                  )}
                </div>
                <div>
      ...
      {showDeleteModal && fertilizerToDelete && (
        ...
        >
          ...
          >
            ...
            <p className="mb-6">
              Delete record for <strong>{fertilizerToDelete.month}</strong>?
            </p>
