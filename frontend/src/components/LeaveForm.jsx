        ...
        <main className="flex-1 p-6 lg:p-8">
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-8">
              <h3 className="text-lg font-semibold text-slate-900 mb-4">Submit a Leave Request</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              {leaveRequests.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 mb-6">Submit a new leave request using the form above.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 m-4 max-w-lg w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-slate-900">{user?.name || 'Unknown'}</h3>
            ...
            <div className="space-y-4">
              ...
              {selectedRequest.status === 'approved' && selectedRequest.approvedBy && (
                <div>
                  <label className="block text-sm font-medium text-slate-500 mb-1">Approved By</label>
                  <p className="text-sm text-slate-900">{selectedRequest.approvedBy.name} ({selectedRequest.approvedBy.email})</p>
                </div>
              )}
              <div className="grid grid-cols-2 gap-4">
                <div>
