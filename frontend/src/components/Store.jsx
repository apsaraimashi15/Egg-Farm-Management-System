            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
              <div>
                ...
                <p className="text-slate-600">
                  Discover our premium farm products
                </p>
              </div>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      ...
                      <svg
                        className="w-4 h-4 mr-2.5 relative z-10 group-hover:rotate-12 transition-transform duration-300"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    {cart.slice(0, 3).map((item) => (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <span className="text-slate-900 truncate max-w-32">
                            {item.name}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2">
          ...
          <div className="p-6">
            ...
            <div className="space-y-4 mb-6 max-h-96 overflow-y-auto">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center space-x-4 p-4 bg-slate-50 rounded-xl relative group"
                >
