...
const addUserSchema = yup.object({
  ...
  role: yup
    .string()
    .oneOf(["employee", "buyer", "admin", "hrmanager"], "Invalid role")
    ...
    try {
      ...
      try {
        ...
        if (logoResponse.ok) {
          ...
          pdf.setFontSize(12);
          pdf.setFont("helvetica", "normal");
          pdf.text("User Management Report", pageWidth / 2, 27, {
            align: "center",
          });
      ...
      function addContent() {
        ...
        filteredUsers.forEach((user, index) => {
          ...
          pdf.text(roleText, roleX + (colWidths[2] - 2) / 2, yPosition + 2.5, {
            align: "center",
          });
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <p className="text-slate-300 max-w-2xl">
                      Oversee user accounts, permissions, and access levels. Add
                      new members, update roles, and maintain a secure and
                      organized workforce.
                    </p>
                  </div>
                      ...
                      <div className="p-3 bg-purple-500/20 rounded-lg">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M5.121 17.804A9 9 0 1112 21h0a9 9 0 01-6.879-3.196m6.879-12.804v9m4.5-4.5h-9"
                          />
                        </svg>
                      </div>
                    </div>
